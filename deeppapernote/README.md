...
[![Status](https://img.shields.io/badge/status-stable-16a34a)](https://github.com/917Dhj/DeepPaperNote (original))
[![Release](https://img.shields.io/github/v/release/917Dhj/DeepPaperNote?display_name=tag&color=0f766e)](https://github.com/917Dhj/DeepPaperNote (original)/releases/tag/v1.0.1)
...
If you prefer the manual path, download the latest [release](https://github.com/917Dhj/DeepPaperNote (original)/releases) zip and extract it.
...
```bash
git clone https://github.com/917Dhj/DeepPaperNote (original).git ~/.codex/skills/DeepPaperNote
git clone https://github.com/917Dhj/DeepPaperNote (original).git ~/.claude/skills/DeepPaperNote
```
