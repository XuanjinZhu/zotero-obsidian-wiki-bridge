...
[![状态](https://img.shields.io/badge/status-stable-16a34a)](https://github.com/917Dhj/DeepPaperNote (original))
[![版本](https://img.shields.io/github/v/release/917Dhj/DeepPaperNote?display_name=tag&color=0f766e)](https://github.com/917Dhj/DeepPaperNote (original)/releases/tag/v1.0.1)
...
如果你更习惯手动安装，推荐去 [release](https://github.com/917Dhj/DeepPaperNote (original)/releases) 页面下载最新版本的 zip 包并解压。
