...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--zotero-attachment-key", default="", help="Local Zotero attachment key if known.")
...
def main() -> None:
    ...
    record = {
        ...
        "zotero_attachment_key": normalize_whitespace(args.zotero_attachment_key),
